...
export function RecommendationsTab() {
  const { runStatus, aiSummary, isSummaryLoading, globallyFilteredResults, promptBreakdownStats, brandBreakdownStats, llmBreakdownStats, isCategory, isPublicFigure } = useResults();
